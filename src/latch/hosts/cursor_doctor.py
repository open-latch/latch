...
from latch.hosts import cursor_backend
from latch.hosts import cursor_hooks
from latch.hosts import cursor_rules_sync
from latch.hosts import cursor_transcript
...
def main(argv: list[str] | None = None) -> int:
    ...
    server_py = str((install_cursor.KB_HOME / "src" / "latch" / "mcp" / "mcp_server.py")).replace("\\", "/")
    checks = run_all(
