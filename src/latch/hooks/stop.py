...
from latch.hooks._common import (
    hook_field, log, project_cwd, read_hook_input, session_id,
    spawn_compactor_detached, transcript_path,
)

from latch.store.paths import UNLATCHED_MESSAGE, is_in_compact, is_unlatched_mode, is_write_disabled
...
def _load_runtime() -> None:
    ...
    if _RUNTIME_LOADED:
        return
    from latch.gate import capture_streams as _capture_streams
    from latch.proof import cite_detector as _cite_detector
