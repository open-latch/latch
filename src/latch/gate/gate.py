...
from latch.retrieval import authority
from latch.gate import capture_streams
from latch.hosts import cursor_backend
from latch.store import db
from latch.common import log_utils
from latch.store import lifecycle_signals
...
from latch.store import priorities
from latch.store import profiles
from latch.proof import project_proof
from latch.gate import request_text_store
from latch.retrieval import search
...
def _resolve_active_workstream_id(
    ...
    """
    try:
        from latch.store import workstreams  # Local import avoids a hard migration-order dependency.
    except ImportError:
