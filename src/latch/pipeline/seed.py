...
KB_HOME = next(p for p in Path(__file__).resolve().parents if p.name == "src").parent
...
def coverage_plan(
    ...
    if project_path is not None:
        try:
            from latch.gate import budget  # noqa: WPS433
...
def llm_candidates(
    ...
    *,
    ...
    if max_calls <= 0:
        return []
    from latch.gate import budget  # noqa: WPS433
    from latch.pipeline import model_backends  # noqa: WPS433
...
def resolve_existing_workstream_target(
    ...
    try:
        ...
        from latch.store import workstreams  # noqa: WPS433
...
def backfill_legacy_seed_claims(conn: Any, *, project_path: str) -> int:
    ...
    from latch.store import db as db_store  # noqa: WPS433
...
def apply_candidates(
    ...
    *,
    ...
    from latch.pipeline import heal  # noqa: WPS433
    from latch.store import db  # noqa: WPS433
    from latch.store import artifacts as artifact_store  # noqa: WPS433
    from latch.common import lockfile  # noqa: WPS433
    from latch.store import workstreams  # noqa: WPS433
