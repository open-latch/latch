#!/usr/bin/env bash
# Cursor preview wiring verifier. Checks .cursor/mcp.json, AGENTS.md, the MCP
# launch target, and optionally Cursor CLI MCP visibility.
...
exec "${PY}" "${KB_HOME}/src/cursor_doctor.py" "$@"
